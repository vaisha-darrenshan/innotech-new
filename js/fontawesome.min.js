...
! function() {
    ...
    function vt(t) {
        ...
        }, "").trim()), ">").concat(n.map(vt).join(""), "</").concat(a, ">")
    }
    ...
    function Zt(t) {
        ...
        var v, p, g, h, y, t = k(k({}, b), {}, {
            ...
            e = n.children,
            n = n.attributes;
        return t.children = e, t.attributes = n, s ? (p = (v = t).prefix, g = v.iconName, h = v.children, y = v.attributes, v = !0 === (v = v.symbol) ? "".concat(p, "-").concat(J.cssPrefix, "-").concat(g) : v, [{
            tag: "svg",
            attributes: {
                style: "display: none;"
            },
        ...
        }]) : (g = (p = t).children, y = p.main, v = p.mask, h = p.attributes, t = p.styles, ot(p = p.transform) && y.found && !v.found && (v = y.width / y.height / 2, y = .5, h.style = rt(k(k({}, t), {}, {
    ...
    function ka(t) {
        var r, o, a, s;
        v && J.observeMutations && (a = t.treeCallback, r = void 0 === a ? fa : a, a = t.nodeCallback, o = void 0 === a ? fa : a, a = t.pseudoElementsCallback, s = void 0 === a ? fa : a, t = void 0 === (t = t.observeMutationsRoot) ? h : t, ya = new v(function(t) {
            var i;
            pa || (i = Nt, et(t).forEach(function(t) {
                var a, e, n;
    ...
    function za(b, v) {
        ...
        return new Promise(function(e, t) {
            ...
            u && "none" !== d && "" !== d ? (s = l.getPropertyValue("content"), a = ~["Sharp"].indexOf(u[2]) ? L : I, n = ~["Solid", "Regular", "Light", "Thin", "Duotone", "Brands", "Kit"].indexOf(u[2]) ? D[a][u[2].toLowerCase()] : X[a][m], d = (l = (l = (d = s).replace(ja, ""), a = 0, s = (m = l).length, c = 55296 <= (d = m.charCodeAt(a)) && d <= 56319 && a + 1 < s && 56320 <= (c = m.charCodeAt(a + 1)) && c <= 57343 ? 1024 * (d - 55296) + c - 56320 + 65536 : d, d = Ea[0] <= c && c <= Ea[1], {
                ...
                prefix: null,
                iconName: null
            }).iconName && l.prefix && (u = l.iconName, n = l.prefix)), !u || c || f && f.getAttribute(C) === n && f.getAttribute(S) === i ? e() : (b.setAttribute(p, i), f && b.removeChild(f), (o = (r = {
                iconName: null,
                title: null,
                titleId: null,
                prefix: null,
            ...
            }).extra).attributes[N] = v, na(u, n).then(function(t) {
                var a = Zt(k(k({}, r), {}, {
                        icons: {
                            main: t,
                            mask: Tt()
    ...
    Fa = {
        ...
        function(t) {
            ...
            p && (g.FontAwesome || (g.FontAwesome = Kt), bt(function() {
                Jt(), Bt("bootstrap")
